...
# ==========================================
# 1. SAYFA YAPILANDIRMASI VE KÜRESEL CSS
# ==========================================
st.set_page_config(
...
# Streamlit standart araç çubuklarını ve alt bilgi yazılarını gizler
st.markdown("""
    <style>
...
# ==========================================
# 3. GİRİŞ EKRANI (MÜKEMMEL STABİLİTE)
# ==========================================
if not st.session_state.logged_in:
    # Form yapısını ezmeden, sadece renk ve form elementlerini biçimlendiren güvenli CSS
    st.markdown("""
    <style>
        ...
        /* GİRİŞ KARTI (Streamlit Yerleşik Formu Hedefleniyor) */
        ...
        /* KOYU LACİVERT VE TAM GENİŞLİKTE GİRİŞ BUTONU */
    ...
    # Giriş formunu dikeyde ortalamak için üst boşluk
    st.markdown("<div style='margin-top: 12vh;'></div>", unsafe_allow_html=True)
    
    # Formun ekranda yayılmasını önlemek adına güvenli dikey sütunlar kuruyoruz
    col_left, col_center, col_right = st.columns([4.4, 3.2, 4.4])
    
    with col_center:
        # st.form kullanımı, elementlerin DOM üzerinde birbirinin içine girmesini kesin olarak engeller
        with st.form(key="f2_login_form"):
            ...
            username_input = st.text_input("Kullanıcı Adı", placeholder="Kullanıcı adınızı yazın", label_visibility="collapsed", key="u_field")
            password_input = st.text_input("Şifre", type="password", placeholder="Şifrenizi yazın", label_visibility="collapsed", key="p_field")
            
            # Formun resmi onay butonu
...
# ==========================================
    ...
    # Giriş başarıyla sağlandıktan sonra arka planı ve sayfa genişliğini temizleyen CSS
    st.markdown("""
    <style>
        ...
        /* Ana sayfadaki filtre alanı buton tasarımları */
