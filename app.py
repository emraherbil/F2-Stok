...
if is_dark:
  ...
  input_border = "#CBD5E0"
  header_bg = LOGO_COLOR
  card_bg = "#F0F2F6"  # 🌟 Metin/Açılır kutuların varsayılan arka plan rengi
  card_text = "#111111"
  card_label = "#555555"
...
st.markdown(
    ...
    <style>
        ...
        {'div[data-testid="stTextInput"] > div > div, div[data-testid="stSelectbox"] > div > div, div[data-baseweb="base-input"], div[data-baseweb="select"] > div { background-color: ' + str(LOGO_COLOR) + ' !important; border-color: #383E4A !important; border-radius: 6px !important; }' if is_dark else ''}
        ...
        {'div[data-baseweb="popover"] div, div[data-baseweb="menu"], div[data-baseweb="option"] { background-color: ' + str(LOGO_COLOR) + ' !important; color: ' + str(input_text) + ' !important; font-weight: normal !important; }' if is_dark else ''}
